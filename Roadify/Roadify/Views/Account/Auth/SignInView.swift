...
struct SignInView: View {
    ...
    var body: some View {
        NavigationView {
            VStack(spacing: 20) {
                ...
                // Email Field
                customTextField("Email Address", text: $viewModel.loginCredentials.email, field: .email, iconName: "envelope")
                    .autocapitalization(.none) // Disable autocapitalization

                // Password Field with eye icon toggle
                passwordTextField("Password", text: $viewModel.loginCredentials.password, field: .password, iconName: "lock", isPasswordVisible: $isPasswordVisible)
    ...
    private func customTextField(_ placeholder: String, text: Binding<String>, field: SignInField, iconName: String) -> some View {
    ...
    private func passwordTextField(_ placeholder: String, text: Binding<String>, field: SignInField, iconName: String, isPasswordVisible: Binding<Bool>) -> some View {
        VStack(alignment: .leading, spacing: 8) {
            Text(placeholder)
                .font(.caption)
                .foregroundColor(Color.white)
